        ...
        <MainLayout>
            ...
            <InnerLayout className={'contact-section'}>
                ...
                <div className="right-content">
                    ...
                    <ContactItem title={'Email'} icon={email} cont1={'aittaouit2001@gmail.com'} cont2={'yanis.aittaouit@edu.esiee.fr'}/>
                    <ContactItem title={'Addresse'} icon={location} cont1={'66 Rue du Départ, Enghien-Les-Bains, France'}/>
