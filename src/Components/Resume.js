    ...
    <ResumeStyled>
      ...
      <InnerLayout>
        <div className="small-title">
          <SmallTitle
            icon={briefcase}
            title={'Stages & expérience professionnelle'}
          />
        </div>
        ...
        <div className="resume-content ">
          ...
          <ResumeItem
            ...
            subTitle={
              'IUT Villetaneuse - Université Sorbonne Paris Nord Villetaneuse'
            }
